...
namespace AiTradingRace.Infrastructure.Migrations
{
    ...
    [Migration("20260120225430_SimplifyUserEntity")]
            ...
            modelBuilder.Entity("AiTradingRace.Domain.Entities.Agent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 20, 22, 54, 29, 982, DateTimeKind.Unspecified).AddTicks(5650), new TimeSpan(0, 0, 0, 0, 0)),
